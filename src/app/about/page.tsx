...
const Page = () => {
  return (
    <>
      <section className="">
        <h1 className="text-primary font-mono text-3xl text-center mt-12">
          Discover. Connect. Play
        </h1>
        <p className="my-8 text-center text-muted-foreground max-w-2xl mx-auto text-sm px-4">
          Basketball is more than just a game, it&apos;s a community. This platform
          helps players, coaches, trainers, and organizers find and share events
          with ease, bringing the basketball world closer together
        </p>
        <article className="py-12 bg-muted px-4">
          ...
          <p className="max-w-2xl mx-auto mt-8">
            ...
            getting the word out about an upcoming event, we&apos;re here to help you
            make it happen.
          </p>
        </article>
        <article className="py-12 bg-basket-background px-4">
          <h2 className="text-2xl font-mono font-medium text-primary text-center">
            Who is it for
          </h2>
          <p className="max-w-2xl mx-auto mt-8">
            Whether you&apos;re an athlete looking for your next tournament, a coach
            organizing team matchups, a trainer offering private sessions, or an
            event organizer planning a big showcase — you&apos;ll find your
            place here. Anyone can explore the platform freely to discover
        ...
        <article className="pt-12 pb-24 px-4">
          ...
          <p className="max-w-2xl mx-auto mt-8">
            Getting started is simple. Navigate to the &apos;Events&apos; tab and start
            browsing events easily through our searchable list, use filters and
            sorting options to help you find exactly what fits your needs. Use
            the toggle buttons to switch from a grid to a table view. Want a
            broader look? Check out the calendar to see what&apos;s coming up, or
            explore the map to find events near you. <br />
